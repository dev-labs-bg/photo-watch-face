...
public class DigitalWatchFaceWearableConfigActivity extends Activity implements
    ...
    private void updateConfigDataItem(final int backgroundColor) {
        ...
        configKeysToOverwrite.putInt(bg.devlabs.photowatchface.DigitalWatchFaceUtil.KEY_BACKGROUND_COLOR,
                backgroundColor);
        bg.devlabs.photowatchface.DigitalWatchFaceUtil.overwriteKeysInConfigDataMap(mGoogleApiClient, configKeysToOverwrite);
    }
